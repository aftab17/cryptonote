...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = E8Z2o68;
...
const char     CRYPTONOTE_NAME[]                             = "taabicoin";
...
const std::initializer_list<const char*> SEED_NODES = {83.110.8.105:17236
